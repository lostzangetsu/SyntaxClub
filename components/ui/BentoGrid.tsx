  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: "linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 36%, rgba(255,255,255,1) 100%)",
      }}
    >
      {/* add img divs */}
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                {leftLists.map((item, i) => (
                  <span
                    ...
                    lg:opacity-100 rounded-lg text-center bg-[#101010] border border-white/[0.2]"
                  >
                    {item}
                  </span>
                ))}
